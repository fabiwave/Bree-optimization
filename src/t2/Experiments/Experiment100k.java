...
public class Experiment100k {
    public static void main(String[] args) throws IOException {
        ...
        for (int j = 8; j <= 8192; j = j * 2) {
            ...
            System.out.println("Search for n = 100.000 and b = " + j);
        ...
        for (int j = 8; j <= 8192; j = j * 2) {
            BinarySearch binary = new BinarySearch("./binary-search.txt", 100000, j);
            ...
            System.out.println("Search for n = 100000 and b = " + j);
